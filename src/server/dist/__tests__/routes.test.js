...
const warehouseModel_1 = __importDefault(
  require("../src/models/warehouseModel")
);
...
const warehouseOne = Object.assign(Object.assign({}, warehouses_1.default[0]), {
  id: WarehouseOneID,
  UserId: UserOneID,
});
const warehouseTwo = Object.assign(Object.assign({}, warehouses_1.default[1]), {
  id: WarehouseTwoID,
  UserId: UserTwoID,
});
const userOne = Object.assign(Object.assign({}, users_1.default[0]), {
  id: UserOneID,
});
const userTwo = Object.assign(Object.assign({}, users_1.default[1]), {
  id: UserTwoID,
});
const userThree = Object.assign(Object.assign({}, users_1.default[2]), {
  id: UserThreeID,
});
describe("testing random routes", () => {
  ...
  describe("Warehouse Routes", () => {
    test("Should get all warehouses", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app)
          .get("/warehouses")
          .expect(200);
        expect(response.body.warehouses).toHaveLength(1);
        expect(response.body.warehouses[0]).toHaveProperty(
          "id",
          WarehouseOneID
        );
      }));
    test("Should create a new warehouse with authenticated user", () =>
      __awaiter(void 0, void 0, void 0, function* () {
    ...
    test("Should filter warehouses based on body attributes", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app)
          .post("/warehouses")
          .send({
    ...
    test("Should get warehouse with this associated id", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app)
    ...
    test("Should delete warehouse with this associated id and authenticated user", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const token = yield (0, userModel_1.generateJWTAuthToken)(userOne);
        const response = yield (0, supertest_1.default)(app)
    ...
    test("Should not delete warehouse for unauthneticated user", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app)
          .delete(`/warehouses/${WarehouseOneID}`)
          .expect(401);
        expect(response.body).toMatchObject({
          error: "Your session is not valid. Token is Invalid",
        });
      }));
    test("Should not delete warehouse for unauthorized user", () =>
      __awaiter(void 0, void 0, void 0, function* () {
  ...
  describe("User Routes", () => {
    ...
    test("Should not login nonexistent user", () =>
      __awaiter(void 0, void 0, void 0, function* () {
    ...
    test("Should delete user", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(response.body).toMatchObject({
          message: "User Deleted With Associated warehouses",
        });
      }));
    ...
    test("Should not get all users for non admin/unauthorized users", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const token = yield (0, userModel_1.generateJWTAuthToken)(userTwo);
        const response = yield (0, supertest_1.default)(app)
          .get(`/users`)
